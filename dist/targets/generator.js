...
`;
export async function generateTarget(query, projectRoot) {
    ...
    if (!validated.success) {
        console.error(`[generator] Generated target failed validation: ${validated.error.issues.map((i) => i.message).join(', ')}`);
        return null;
    }
