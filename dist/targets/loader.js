...
export async function loadTargets(projectRoot) {
    ...
    if (!existsSync(filePath)) {
        ...
        console.warn(`[targets] Using legacy root ${LEGACY_TARGETS_FILE} — move it to ${TARGETS_FILE} (the canonical location).`);
...
export function resolveTargetPaths(target, projectRoot) {
