...
function resolveDefaultReferer() {
    try {
...
export class OpenRouterProvider extends OpenAICompatibleProvider {
    constructor(apiKey, model, maxConcurrency, baseUrl, deadlineMs = DEFAULT_DEADLINE_MS, referer = DEFAULT_REFERER, title = DEFAULT_TITLE) {
        const config = {
            name: 'openrouter',
            label: 'OpenRouter',
